...
public class DeleteServiceAction extends UnsecuredAction {

	private final Logger logger = Appctx.getLogger(DeleteServiceAction.class
			.getName());
	...
	public String process0(final Session s, final HttpServletRequest req,
		...
		SQLQuery i = s.createSQLQuery("delete from ts_inst_lb where hostnm='"
				+ hostname + "' and inport=" + inport + " and outport="
				+ outport + " and backend='" + backend + "'");
		i.executeUpdate();
