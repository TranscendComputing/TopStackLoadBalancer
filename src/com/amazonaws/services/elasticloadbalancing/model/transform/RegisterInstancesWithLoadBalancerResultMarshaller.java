...
public class RegisterInstancesWithLoadBalancerResultMarshaller
		implements
		Marshaller<String, MarshallStruct<RegisterInstancesWithLoadBalancerResult>> {

	@Override
	public String marshall(
			final MarshallStruct<RegisterInstancesWithLoadBalancerResult> in)
			throws Exception {
